sheetApp.controller(
  ...
  function (
    ...
    $scope.get_my_issues = function () {
      ...
      // ) {
      //   var externalApiUrl =
      //     "https://issues.unionsg.com/api/incidents.php?department_id=" +
      //     $scope.user_info.deptIssues;
      // } else if (
      //   $scope.user_info.role == "developer" &&
      //   $scope.user_info.is_dept_head == "0"
      // ) {
      //   externalApiUrl =
      //     "https://issues.unionsg.com/api/incidents.php?email=" +
      //     $scope.user_info.email;
      // }
      // var externalApiUrl = "https://issues.unionsg.com/js/getIncidents.php?email=" +$scope.user_info.email
      // var externalApiUrl = "https://issues.unionsg.com/api/incidents.php?department_id=" +$scope.user_info.email
      // var externalApiUrl = "https://issues.unionsg.com/api/incidents.php?department_id="+6
      // https://issues.unionsg.com/api/incidents.php?department_id=6
      ...
      $http({
        ...
        function successCallback(response) {
          ...
          $scope.new_stats = response?.data?.data;
          console.log("This is the results");
          console.log($scope.new_stats);
        },
    ...
    $scope.get_projects_by_is_approved = function (
      user_id,
      is_approved,
      ...
      if (_user_info_role == "developer") {
        var _url =
          "getAllProjects_ForDeveloper.php?user_id=" +
          user_id +
          "&is_approved=" +
          is_approved +
          "&department_id=" +
        ...
        var _url =
          "getAllProjects_ForAssigner_&_Admin.php?is_approved=" + is_approved;
        console.log(_url);
      } else if (_user_info_role == "department_head") {
        var _url =
          "getAllProjects_ForDepartmentHead.php?is_approved=" +
          is_approved +
          "&department_id=" +
          department_id;
      }

      dataService.get_all_project(_url).then(
        function successCallback(response) {
    ...
    $scope.downloadExcel = function () {
      ...
      window.location.href =
        "./apiSheet/projectReportById2.php?dept_id=" + dept_ID;
    ...
    $scope.get_tasks_by_status_id = function (
      ...
      if (dev_changed == 0) {
        if (_user_info_role == "developer") {
          _url =
            myConfig.url +
            "/getAllProjects_ForDeveloper_.php?user_id=" +
            user_id +
            "&status_id=" +
            status_id;
        } else if (_user_info_role == "assigner_and_admin") {
          if (user_id == 0) {
            _url =
              myConfig.url +
              "/getAllProjects_ForDepartmentHead.php?status_id=" +
              status_id +
              "&department_id=" +
              department_id;
          }
          _url =
            myConfig.url +
            "/getAllProjects_ForAssigner_&_Admin.php?status_id=" +
            status_id;
        } else if (_user_info_role == "department_head") {
          _url =
            myConfig.url +
    ...
    $scope.get_tasks_by_status_id_ = function (
      user_id,
      status_id,
      statistics_description_name,
      _user_info_role,
      _user_info_department_id
    ) {
    ...
    $scope.get_total_projects = function (
      user_id,
      statistics_description_name,
      _user_info_role,
      department_id,
      ...
      if (dev_changed == 0) {
        if (_user_info_role == "developer") {
          ...
          _url =
            "getAllProjects_ForDepartmentHead.php?department_id=" +
            department_id;
        }
      } else {
    ...
    $scope.get_statics_developer_for_developer_ = function (init, user_id) {
      ...
      var _url =
        myConfig.url +
        "/getCodeStatusCount_ForDeveloper_.php?init=" +
        init +
        "&user_id=" +
        user_id;
      // var _url = 'getAllProjects_ForDeveloper.php?user_id=' + user_id
    ...
    $scope.get_statics_developer_for_developer = function (
      ...
      var _url =
        myConfig.url +
        "/getCodeStatusCount_ForDeveloper.php?init=" +
        init +
        "&department_id=" +
        department_id +
        "&is_dept_head=" +
    ...
    $scope.get_statics_developer_for_department_head = function (
      ...
      var _url =
        myConfig.url +
        "/getCodeStatusCount_Project_For_Dept_Head.php?init=" +
        init +
        "&department_id=" +
        department_id;
    ...
    $scope.get_statics_developer_for_assigner_and_admin = function (init) {
      var _url =
        myConfig.url +
        "/getCodeStatusCount_Project_For_Assigner_&_Admin_1.php?init=" +
        init;
    ...
    if (
      ...
      // $scope.get_all_developers($scope.user_info.department_id)
      $scope.get_statics_developer_for_developer(
        "psta",
        $scope.user_info.department_id,
        0,
        $scope.user_info.user_id
    ...
    $scope.get_by_date_range_and_status = function () {
      ...
      var _url =
        myConfig.url +
        "/getAllProjects_ForDeveloper_.php?start_date=" +
        start_date +
        "&end_date=" +
        end_date +
        "&status_id=" +
