sheetApp.controller("TaskDetailsCtrl", function($scope, $http, $location) {
    ...
    $scope.dateRangeDisplay = $scope.formatDisplayDate($scope.start_date) + ' to ' + $scope.formatDisplayDate($scope.end_date);
    ...
    $scope.fetchTaskDetails = function() {
        $http.get('apiSheet/get_task_details.php', {
            params: {
