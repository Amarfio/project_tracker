...
if (
    ...
    if ($check_dept_head_count >= 1) {
        ...
        <br />
        Kindly <a href='http://192.168.1.195:84/project_tracker/set_password/$set_password'>click here</a> to reset your password. And also attached to this email is a manual on how to use the Application.
        <br /><br/>
        Kind regards,
        <br/>
