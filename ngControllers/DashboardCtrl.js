sheetApp.controller(
  ...
  function (
    ...
    $scope.get_tasks_by_status_id = function (
      ...
      if (dev_changed == 0) {
        if (_user_info_role == "developer") {
          ...
          _url =
            myConfig.url +
            "/getAllProjects_ForClient.php?status_id=" +
            status_id +
            "&client_id=" +
            $scope.client_id;
        } else if (_user_info_role == "assigner_and_admin") {
    ...
    $scope.get_statics_developer_for_client = function (init) {
      var _url =
        myConfig.url +
        "/getCodeStatusCount_Project_For_Client.php?init=" +
        init +
        "&client_id=" +
        $scope.client_id;
    ...
    if ($scope.user_info.role == "guest") {
      // $scope.get_all_developers($scope.user_info.department_id)
      $scope.get_statics_developer_for_client(
        "psta",
        $scope.user_info.department_id,
        0,
        $scope.user_info.user_id
    ...
    $scope.get_by_date_range_and_status = function () {
      ...
      interested_p = $scope.interested_person;
      ...
      var _url =
        myConfig.url +
        "/getAllProjects_ForDeveloperA.php?start_date=" +
        start_date +
        "&end_date=" +
        end_date +
        "&status_id=" +
