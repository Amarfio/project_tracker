var sheetApp = angular.module("sheetApp", [
    "ngRoute",
    "ngCookies",
    "ngStorage",
]);
...
sheetApp.config([
    ...
    function($routeProvider, $locationProvider) {
        ...
        $routeProvider
            ...
            .when("/statistics_p", {
                templateUrl: "./templates/statistics_p.html",
            ...
            .when("/statisticsnew", {
                templateUrl: "./templates/statisticsnew.html",
                controller: "StatisticsnewCtrl",
            })
            .when("/task_details", {
            ...
            .when("/tasks_analysis", {
                templateUrl: "./templates/tasks_analysis.html",
                controller: "TasksAnalysisCtrl",
            })
            .when("/user_details.html", {
...
sheetApp.service("get_services", function(myConfig, $http) {
    ...
    this.get_one_code_description = function(code_desc, file) {
        $http.get(myConfig.url + file + code_desc).then(
            function successCallback(response) {
...
sheetApp.service("dataService", function($http, myConfig) {
    ...
    this.get_one_code_description = function(code_desc, file) {
        return $http.get(urlBase + file + code_desc).then(
            function successCallback(response) {
                var code_desc;
