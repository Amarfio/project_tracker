<?php
  ...
  if(isset($_GET['dept_id'])){
    ...
    $setSql = "SELECT project_id, project_name, owner, start_date, end_date, completion, status, last_update, last_update_date FROM `vw_proj_update_by_dept` WHERE dept_id = $dept_id ORDER BY start_date DESC";
