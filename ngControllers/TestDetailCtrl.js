sheetApp.controller('TestDetailCtrl', function ($scope, $http, $routeParams, check_auth, myConfig, $location, $localStorage) {
    // $scope.test_id = atob($routeParams.test_id);
    ...
    //     $http({
    //         method: 'GET',
    //         url: myConfig.url + '/getAttachFileOfTaskComment.php?test_id=' + $scope.test_id
    ...
    $scope.get_one_test = function () {
        $http({
            method: 'GET',
            url: myConfig.url + '/getOneTest.php?test_id=' + $scope.test_id
    ...
    $scope.get_task_comments = function () {
        $http({
            method: 'GET',
            url: myConfig.url + '/getTaskComment.php?test_id=' + $scope.test_id
    ...
    $scope.sendComment = function (test_id, comment_message, user_id) {
        // console.log(test_id);
