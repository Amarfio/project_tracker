...
require_once 'functions/formatDate.php';
 function approvedApproval($project_id, $name, $version_name, $department, $start_date, $end_date){
    ...
    * {
    ...
    <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
      ...
      <div style='font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;'>
        <div>
    <div><strong>The Project that was submitted for approval has been duly approved, below includes the details for the project.</strong></div>
    </div>
      </div>
