...
if ( isset($_GET['status_id']) && isset($_GET['department_id'])) {
     ...
     result_from_query ($conn, query_project ($status_id, $department_id));

}else if(!isset($_GET['status_id']) && isset($_GET['department_id'])){

 $department_id = mysqli_escape_string($conn, $_GET['department_id']);

      result_from_query ($conn, query_project ($status_id = null, $department_id));

}else if(isset($_GET['status_id']) && !isset($_GET['department_id'])){

    $status_id = mysqli_escape_string($conn, $_GET['status_id']);
     result_from_query ($conn, query_project ($status_id , $department_id = null));
}
