...
function query_total_task($conn, $task_id, $owner_id){ 
    ...
    $query_total_task = "SELECT * FROM `vw_clashing_tasks` where task_id = '$task_id' AND task_one_owner = '$owner_id'";
    // echo($query_total_task);
...
if(isset($_GET['task_id'])){
 ...
 $owner = mysqli_escape_string($conn, $_GET['assigned_to']);

    query_total_task ($conn, $task_id, $owner);
