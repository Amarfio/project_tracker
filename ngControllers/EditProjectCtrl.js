sheetApp.controller(
  ...
  function (
    ...
    $scope.UpdateProject = function (
      ...
      //get the client id
      if (client_ == "" || client_ == undefined) {
        var client_ = $scope.project.client_id;
        console.log(client_);
      }
    ...
    //code to check for department members based on the passed id
    ...
    //code to get the staff of the project team
