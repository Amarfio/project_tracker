...
$query_users_by_department_id = "SELECT us.id user_id, us.f_name, us.l_name, co_d.desc, us.email, us.phone, us.gender, us.profile_pic, us.bio, us.country, us.city, us.postal_addr, co_d.id department_id, co_d.desc department, co_r.desc role FROM users us LEFT JOIN code_desc co_d ON co_d.id = us.dept LEFT JOIN code_desc co_r ON co_r.id = us.role WHERE co_d.id = '$department_id' AND (us.role= 70 AND us.is_active = 1)";
    ...
    $query_all_users = "SELECT us.id user_id, us.f_name, us.l_name, co_d.desc, us.email, us.phone, us.gender, us.profile_pic, us.bio, us.country, us.city, us.postal_addr, co_d.id department_id, co_d.desc department, co_r.desc role FROM users us LEFT JOIN code_desc co_d ON co_d.id = us.dept LEFT JOIN code_desc co_r ON co_r.id = us.role WHERE (us.role = 70 OR us.role = 68) AND us.is_active = 1 ORDER BY us.f_name ASC";
