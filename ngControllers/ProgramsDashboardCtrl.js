sheetApp.controller('ProgramsDashboardCtrl', function ($scope, dataService, check_auth, myConfig, $http, $location, $localStorage, $location) {
    ...
    $scope.get_programs = function (){
        ...
        $http({
            method: 'GET',
            url: myConfig.url + '/getAllPrograms.php'
