                                  ...
                                  <tr>
                                    <td style='overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;' align='left'>
                                      ...
                                      <div style='line-height: 160%; text-align: center; word-wrap: break-word;'>
                                        ...
                                        <p style='font-size: 14px; line-height: 160%;'><span style='font-size: 18px; line-height: 28.8px;'>Your account has been created successfully for the Project Tracker Application. Kindly click the reset password below to reset your password. And also attachment to this email is a manual on how to use the application. <br /></span></p>
                                      </div>
