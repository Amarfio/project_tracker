...
if(isset($data) && isset($data->reply) && isset($data->comment_id) && isset($data->replied_by)){
    ...
    $query = "INSERT INTO `replies` (`reply_id`, `reply`, `c_id`, `replied_by`) VALUES (NULL, '$reply', '$comment_id', '$replied_by')";
