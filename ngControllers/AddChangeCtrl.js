sheetApp.controller('AddChangeCtrl', function ($scope, $http, $timeout, check_auth, myConfig, get_services, $location, $localStorage, dataService) {
    ...
    $scope.createProject = function (project_name_, version_no_, department_id_, start_date_, end_date_, project_description_,project_owner_, project_owner_2 ) {
