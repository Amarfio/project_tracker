sheetApp.controller('ProjectUpdatesDashboardCtrl', function ($scope, dataService, check_auth, myConfig, $http, $location, $localStorage, $location) {
    ...
    $scope.get_by_date_range_and_developer = function () {
        ...
        var _url = myConfig.url + '/getAllProjectsUpdates_ForAssigner_&_AdminA.php?start_date='+ start_date +'&end_date=' + end_date+ '&status_id=' + status_id+ '&user_id=' + user_id;
